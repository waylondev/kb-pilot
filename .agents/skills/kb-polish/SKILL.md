...
description: >-
  ...
  EPUB, CSV, RTF, OpenDocument odt/ods/odp) into high-quality Markdown for kb-pilot ingestion.
  Does NOT OCR - pure scans (no text layer) are kept as page images.
  Use when converting docs to Markdown, PDF-to-MD, Word-to-MD, pre-ingestion prep,
  or conversion-quality verification.
license: MIT
