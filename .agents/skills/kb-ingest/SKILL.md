...
- [ ] 2. If `drifted` is false → skip. If true → re-run ingest workflow Step 4 (the script preserves existing summary/keywords and the document-level summary where the heading structure still matches)
