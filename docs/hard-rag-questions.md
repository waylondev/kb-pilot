...
> 基于 `datasets/` 目录下的文档设计，专门针对传统 RAG 系统的薄弱环节：多跳推理、跨文档关联、上下文割裂、条件推理、否定推理。
...
**信用卡资格条件** — `datasets/zx-bank-credit-card.md`:
...
**摩托车贷款** — `datasets/zx-bank-bike-loan.md`:
...
**自动转换规则** — `datasets/salary-account-to-a-savings-account.md`:
...
**最低余额** — `datasets/savings-account-overview.md`:
...
**数字渠道转换** — `datasets/salary-account-to-a-savings-account.md`:
...
**卡/支票簿保留** — `datasets/salary-account-to-a-savings-account.md`:
...
**绿色金融奖项** — `datasets/awards-and-recognitions.md`:
...
**存款参与 ESG** — `datasets/zx-bank-fixed-deposits.md`:
...
**欺诈冻结渠道** — `datasets/fraud-transaction.md`:
...
**App 内冻结卡片** — `datasets/zx-bank-asia-mobile-app-guide.md`:
- L75: `- **Block Card**: Select card → More options → Block (immediate effect).`

**解决时间** — `datasets/fraud-transaction.md`:
- L54: `- ZX Bank targets resolution within 10 working days.`

**支票簿申请渠道** — `datasets/apply-for-a-cheque-book.md`:
...
**房屋贷款文件** — `datasets/zx-bank-house-loan.md`:
...
**汽车贷款文件** — `datasets/zx-bank-car-loan.md`:
...
**海得拉巴西区分行** — `datasets/hyderabad-branch-network.md`:
- L49-50: `| Madhapur Kavuri Hills, 500081                   | ZXIN0001232   | 040-45671232    |`

**HITEC City 位置** — `datasets/atm-locations-at-tech-parks-in-major-indian-cities.md`:
- L48-49: `1. **HITEC City**` / `   Madhapur, Hyderabad, Telangana 500081`

**孟买科技园区 ATM** — `datasets/atm-locations-at-tech-parks-in-major-indian-cities.md`:
- L9-16: Mindspace Airoli IT Park / Nesco IT Park / Infinity IT Park

**ATM 定位方式** — `datasets/zx-bank-asia-mobile-app-guide.md`:
- L117: `- **Locate Branch/ATM**: Find ZX Bank locations in all supported countries`

**ATM 定位方式** — `datasets/atms-at-railway-stations-and-airports.md`:
...
**保险箱前提条件** — `datasets/open-a-locker.md`:
...
**保险箱操作** — `datasets/open-a-locker.md`:
...
**FD 在线开立** — `datasets/zx-bank-fixed-deposits.md`:
...
**跨境汇款时间** — `datasets/cross-border-payments.md`:
...
**NRI 信用卡条件** — `datasets/zx-bank-credit-card.md`:
...
**WhatsApp Zia** — `datasets/ask-zia-your-24-7-banking-assistant.md`:
...
**不丹运营** — `datasets/about-zx-bank-ltd.md`:
